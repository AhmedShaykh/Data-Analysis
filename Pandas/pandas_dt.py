...
studentsData = [
    ...
    {"Roll_No": 5, "Name": "Samara", "Father_Name": "John", "Course": "Computer Science", "Date_Of_Admission": "2023-11-16", "Fee": 14000},
...
studentsDf = pd.DataFrame(studentsData);
...
print(studentsDf["Date_Of_Admission"].dt.tz_localize("UTC"));

print(studentsDf["Date_Of_Admission"].dt.tz_localize("UTC").dt.tz_convert("Asia/Karachi"));
