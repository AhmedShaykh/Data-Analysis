...
try:
    ...
    if age < 18:
        raise ValueError("Sorry Your Not Eligible"); # Raise Throw Custom Exception Error
...
with open("./app.txt") as file: # Automatically Close Your File Connectivity After Done
...
with open("./app3.txt", "w") as file: # W (Write) Is Create New File & If File Exist Remove Old Content Add New
...
with open("./app3.txt", "r+") as file: # Read & Write Both In File But (R+) Add New Content With Old Content Not Remove

    print(file.read());

    file.write(" Release Imran Khan"); # After Run Write Cursor Go In Last
...
with open("./app4.txt", "a") as file: # If File Not Exist (A) Will Create New File & If Exist Add Content In Last Of File Not Remove

    file.write("Palestine");

with open("./app5.txt", "x") as file: # If File Not Exist Then (X) Will Create New File
...
class Factory:
    ...
    def show(self): # Self Parameter Like (This Parameter In JS) But It Must Write In Class Method & Init Method (Function & Constructor) 
...
pet = Animal("Horse"); # When New Object It Must Be Give Attribute Value
...
class Animal:
    ...
    def __init__(self, name = None): # Set Attribute Value Default None
        if name == None:
...
class Animal:
    ...
    def pet(cls): # Class Method
        print(f"My Favorite Pet Is: {cls.name}"); # Only Target Class Attribute
...
class Teacher:
    ...
    def __init__(self, teacherId, teacherName):
        ...
        self.organizationName = "LangChain";

    def teaching(self, subject ):
        print(f"{self.teacherName} Is Teaching {subject}...!");

obj1 = Teacher(1, "Andrew NG");

obj2 = Teacher(2, "Elon Musk");

print(f"Name: {obj1.teacherName}, ID: {obj1.teacherId} & Organiztion: {obj1.organizationName}");

print(f"Name: {obj2.teacherName}, ID: {obj2.teacherId} & Organiztion: {obj2.organizationName}");
...
class Teacher:
    ...
    def __init__(this, teacherName):
        ...
        this.organizationName = "LangChain";
        Teacher.counter += 1;
...
obj1 = Teacher("Andrew NG"); # When Create New Object & Automatically Increase The Value Of Counter

print(obj1.counter);

print(Teacher.counter);

obj2 = Teacher("Elon Musk");
...
class StudentLogin(): # Encapsulation
    ...
    def login(self, user1 , pass1):
        message = self.__dbConnectivity(user1, pass1);
        print(message);
...
class Animal(ABC):  # Abstraction
    ...
    @abstractmethod
    def eat(self, food): # Abstract Method Logic Must Be Implemented In The Child Class
        ...;
...
postApi = "https://jsonplaceholder.typicode.com/todos";

new_todo = {
    "userId": 4,
    "title": "Learn Python With REST API",
    "completed": True
};

response = requests.post(postApi, json = new_todo);
